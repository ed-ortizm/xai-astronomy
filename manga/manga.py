...
(wave, raw_flux, stellar_velocity_field) = input_format.get_data(
    plate_ifu=plate_ifu, data_directory=manga_data_directory
)
####################################################################
...
wave_master = np.linspace(
    wave_master_lower, wave_master_upper, number_wave_master
)
####################################################################
