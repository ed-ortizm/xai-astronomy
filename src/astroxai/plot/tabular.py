...
class PlotExplanation:
    ...
    def plot_explanation(
        ...
        line, = ax.plot(
            wave, spectrum[:-8], c="black", linewidth=linewidth, alpha=alpha
        )
    ...
    def _colorbar_explanation(self, fig, vmin, vmax):
        ...
        cb = mpl.colorbar.ColorbarBase(
            ax_cb, cmap=cmap, norm=norm, orientation="vertical", extend="both"
        )
