...
class Neighbors:
    ...
    #####################################################################
    def get_neighbors(
        self, number_samples: int = 50, hide_color: float = 0.0
        ...
        hide_color: value to fill segments that
            ...
            per channel
        OUTPUT
        (neigbors, on_off_batch_super_pixels)

        neighbors: array with sampled neighbors. The first
            element of the array is the original image
        on_off_batch_super_pixels: boolean array with masked
            superpixels per neighbor
        """
        ...
        for on_off_super_pixels in on_off_batch_super_pixels:
            ...
            idx_off_super_pixels = np.argwhere(
        ...
        return np.array(neighbors), on_off_batch_super_pixels
